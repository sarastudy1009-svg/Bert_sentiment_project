...
from src_lee_taehyuk.config import DEFAULT_DATA_PATH, DEFAULT_MODEL_NAME, MAX_LEN, MODEL_DIR, SEED
from src_lee_taehyuk.data_loader import load_sentiment_csv, split_dataset
from src_lee_taehyuk.dataset import BertSentimentDataset
from src_lee_taehyuk.modeling import apply_fine_tuning_strategy, count_trainable_parameters, create_model
from src_lee_taehyuk.utils import get_device, set_seed
...
def train(args: argparse.Namespace) -> None:
    ...
    # 학습에 사용할 한국어 토크나이저를 다운로드하거나 캐시에서 불러옵니다.
...
def parse_args() -> argparse.Namespace:
    ...
    # 사용할 사전 학습 한국어 BERT 모델명을 입력받습니다.
    parser.add_argument("--model_name", type=str, default=DEFAULT_MODEL_NAME, help="Hugging Face 한국어 BERT 모델명 (예: klue/bert-base)")

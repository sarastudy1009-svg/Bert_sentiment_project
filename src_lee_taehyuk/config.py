...
# 영어 모델(src/models/bert_sentiment)과 겹치지 않도록 별도 폴더를 사용합니다.
MODEL_DIR = BASE_DIR / "models" / "bert_sentiment_kor"

# 예제 데이터 경로입니다. 사용자가 별도 데이터를 준비하지 않아도 학습 테스트가 가능합니다.
# 한국어 리뷰/감성 라벨로 구성된 예제 CSV를 사용합니다.
DEFAULT_DATA_PATH = DATA_DIR / "sample_sentiment_kor.csv"

# Hugging Face에서 내려받을 기본 BERT 모델명입니다.
# 한국어 감성분석을 위해 KLUE 벤치마크 기반 한국어 BERT 모델을 사용합니다.

...
# NSMC 전처리 후 저장되는 파일 경로입니다.
DEFAULT_DATA_PATH = DATA_DIR / "nsmc_sentiment.csv"

# 예제 데이터 경로입니다. 사용자가 별도 데이터를 준비하지 않아도 학습 테스트가 가능합니다.
SAMPLE_DATA_PATH = DATA_DIR / "sample_sentiment.csv"

# Hugging Face에서 내려받을 기본 BERT 모델명입니다.
# kykim/bert-kor-base: 한국어 전용 BERT 사전학습 모델입니다.

"""KLUE-BERT 분류 모델 생성과 Fine-tuning 범위 설정을 담당하는 파일입니다."""

from transformers import BertForSequenceClassification

# 한국어 감성분석에 사용할 KLUE-BERT 기본 모델명입니다.
KLUE_BERT_MODEL_NAME = "klue/bert-base"


def create_model(model_name: str = KLUE_BERT_MODEL_NAME, num_labels: int = 2) -> BertForSequenceClassification:
    """Hugging Face Hub 또는 로컬 경로에서 KLUE-BERT 문장 분류 모델을 불러옵니다."""
    # BertForSequenceClassification은 BERT 본체 위에 분류용 Linear Layer가 붙은 모델입니다.
    # klue/bert-base는 한국어 말뭉치로 사전 학습된 BERT Base(12-layer) 모델입니다.

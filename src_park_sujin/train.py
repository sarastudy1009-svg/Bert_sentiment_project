...
from src.config import DEFAULT_DATA_PATH, DEFAULT_EPOCHS, DEFAULT_MODEL_NAME, MAX_LEN, MODEL_DIR, SEED
...
def parse_args() -> argparse.Namespace:
    ...
    # 학습 epoch 수를 입력받습니다. CPU 환경에서 2,000건 샘플 기준 적당한 기본값입니다.
    parser.add_argument("--epochs", type=int, default=DEFAULT_EPOCHS, help="학습 반복 횟수")

    # 학습 배치 크기를 입력받습니다. CPU 환경 메모리 부담을 고려해 보수적으로 설정했습니다.
